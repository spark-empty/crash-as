...
extern void CanIf_OsekNmUserRxIndication(uint8 channel, PduIdType pduId, const uint8 *sduPtr, uint8 dlc, Can_IdType canId);
extern void CanIf_OsekNmUserTxConfirmation(PduIdType);
...
CanIf_TxPduConfigType CanIfTxPduConfigData[] = 
{
    ...
    {
        .CanIfTxPduId = PDUR_ID2_OSEK_NM_TX,
    ...
    #endif
        .CanIfTxPduIdCanIdType = CANIF_CAN_ID_TYPE_11,
        .CanIfUserTxConfirmation = CanIf_OsekNmUserTxConfirmation,
        .CanIfCanTxPduHthRef = &CanIfHthConfigData_CANIF_CHL_LS[0],
        .PduIdRef = NULL
    },
...
static const CanIf_RxPduConfigType CanIfRxPduConfigData[] = 
{
    ...
    {
        .CanIfCanRxPduId = PDUR_ID_OSEK_NM_RX,
        .CanIfCanRxPduCanId = 0x400,
        .CanIfCanRxPduDlc = 8,
#if ( CANIF_CANPDUID_READDATA_API == STD_ON )
        .CanIfReadRxPduData = TRUE,
#endif
        ...
        .CanIfUserRxIndication = CanIf_OsekNmUserRxIndication,
        .CanIfCanRxPduHrhRef = &CanIfHrhConfigData_CANIF_CHL_LS[0],
        .PduIdRef = NULL,
        .CanIfSoftwareFilterType = CANIF_SOFTFILTER_TYPE_MASK,
        .CanIfCanRxPduCanIdMask = 0x7FF
