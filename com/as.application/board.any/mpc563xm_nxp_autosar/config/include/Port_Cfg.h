 ...
 */
#define PortContainer_0_CAN_A_TX      0
#define PortContainer_0_CAN_A_RX      1
#define PortContainer_0_LED1      2
#define PortContainer_0_KEY1      3
 ...
 */
#define PORT_MAX_PIN_SETTINGS   (uint8)4
 ...
 */
#define PAD_MODE_OPTIONS        (uint8)9
/**
 * @brief Platform constant: number of available pad modes
 */
