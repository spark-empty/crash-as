...
CONST(Icu_ChannelType,ICU_CONST) Icu_InitPBChannelIndex_[!"@index"!][[!"num:i($count)"!]] = {[!LOOP "IcuChannel/*"!][!//
...
[!IF "IcuMeasurementMode='ICU_MODE_EDGE_COUNTER'"!](Icu_ChannelType)[!"num:inttohex($edge,2)"!][!VAR "edge" = "$edge + 1"!][!ELSE!][!//
...
CONST(Icu_ChannelType,ICU_CONST) Icu_InitPBHWMap_[!"@index"!][ICU_MAX_HW_CHANNELS + 1U] = {[!"$strcast"!]};
...
CONST(Icu_ChannelType,ICU_CONST) Icu_InitPBHWWKMap_[!"@index"!][ICU_MAX_HW_CHANNELS + 1U] = {[!"$strcast"!]};
