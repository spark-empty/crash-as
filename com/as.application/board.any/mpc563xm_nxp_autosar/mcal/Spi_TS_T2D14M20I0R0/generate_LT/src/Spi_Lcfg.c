...
[!LOOP "SpiDriver/*[1]/SpiJob/*"!][!//
static CONST(Spi_ChannelType, SPI_CONST) [!"name(.)"!]_ChannelAssignment_LT[[!"num:i(count(ChannelAssignment/*))"!]] = {[!//
...
[!LOOP "SpiDriver/*[1]/SpiSequence/*"!][!//
static CONST(Spi_JobType, SPI_CONST) [!"name(.)"!]_JobAssignment_LT[[!"num:i(count(JobAssignment/*))"!]] = {[!//
[!LOOP "JobAssignment/*"!][!//
...
CONST(Spi_ConfigType, SPI_CONST) [!"node:name(SpiDriver/*[1])"!] =
{
