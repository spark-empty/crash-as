...
#define LIN_AR_MAJOR_VERSION_CFG_C  [!"CommonPublishedInformation/ArMajorVersion"!]
#define LIN_AR_MINOR_VERSION_CFG_C  [!"CommonPublishedInformation/ArMinorVersion"!]
#define LIN_AR_PATCH_VERSION_CFG_C  [!"CommonPublishedInformation/ArPatchVersion"!]
#define LIN_SW_MAJOR_VERSION_CFG_C  [!"CommonPublishedInformation/SwMajorVersion"!]
#define LIN_SW_MINOR_VERSION_CFG_C  [!"CommonPublishedInformation/SwMinorVersion"!]
#define LIN_SW_PATCH_VERSION_CFG_C  [!"CommonPublishedInformation/SwPatchVersion"!]
