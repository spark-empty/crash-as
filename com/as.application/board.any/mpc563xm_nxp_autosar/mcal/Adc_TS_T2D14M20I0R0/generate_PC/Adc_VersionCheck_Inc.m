...
[!ASSERT "ArMajorVersion = num:i($ADC_AR_MAJOR_VERSION_TEMPLATE)"!]
        **** AUTOSAR major version number of the Basic Software Module Description file (Adc.epd version [!"ArMajorVersion"!]) and the Code template file (Adc_Cfg.h version [!"num:i($ADC_AR_MAJOR_VERSION_TEMPLATE)"!]) are different ****
[!ENDASSERT!][!//
[!ASSERT "ArMinorVersion  = num:i($ADC_AR_MINOR_VERSION_TEMPLATE)"!]
        **** AUTOSAR minor version number of the Basic Software Module Description file (Adc.epd version [!"ArMinorVersion"!]) and the Code template file (Adc_Cfg.h version [!"num:i($ADC_AR_MINOR_VERSION_TEMPLATE)"!]) are different ****
[!ENDASSERT!][!//
[!ASSERT "ArPatchVersion  = num:i($ADC_AR_PATCH_VERSION_TEMPLATE)"!]
        **** AUTOSAR patch version number of the Basic Software Module Description file (Adc.epd version [!"ArPatchVersion"!]) and the Code template file (Adc_Cfg.h version [!"num:i($ADC_AR_PATCH_VERSION_TEMPLATE)"!]) are different ****
[!ENDASSERT!][!//
*/!]
