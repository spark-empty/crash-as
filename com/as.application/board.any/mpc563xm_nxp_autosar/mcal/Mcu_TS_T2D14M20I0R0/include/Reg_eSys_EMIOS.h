/**
    ...
    @brief   AUTOSAR Mcu - EMIOS register and bitfield defines.
    @details EMIOS register and bitfield defines, used by different drivers that access the EMIOS 
             resources.
...
identifier:_REG_ESYS_EMIOS_H_- See @ref Reg_eSys_EMIOS_h_3 under  
AutoSAR requirement  number. SWS COMPILER010
*/
#ifndef _REG_ESYS_EMIOS_H_
#define _REG_ESYS_EMIOS_H_
...
#define REG_ESYS_EMIOS_H_AR_MAJOR_VERSION     3
#define REG_ESYS_EMIOS_H_AR_MINOR_VERSION     0
#define REG_ESYS_EMIOS_H_AR_PATCH_VERSION     0
#define REG_ESYS_EMIOS_H_SW_MAJOR_VERSION     2
#define REG_ESYS_EMIOS_H_SW_MINOR_VERSION     0
#define REG_ESYS_EMIOS_H_SW_PATCH_VERSION     0
/**@}*/
...
==================================================================================================*/
    ...
    #if ((REG_ESYS_EMIOS_H_AR_MAJOR_VERSION != MODULES_AR_MAJOR_VERSION_H) || \
         (REG_ESYS_EMIOS_H_AR_MINOR_VERSION != MODULES_AR_MINOR_VERSION_H))
...
*/
extern CONST(uint32, EMIOS_VAR) EMIOS_BASE_ADDR[];
...
/**@note  Violates MISRA 2004 Advisory Rule 19.7, Use of function like macro -
          See @ref Reg_eSys_EMIOS_h_2*/
/* This is applicable for the following lines of code */
/*lint -save -e961 */
/**
@{
@brief EMIOS Module Registers - global registers, mIdx : emios module index 0 for emiosA,
       1 for emiosB
*/
...
/**
@{
@brief EMIOS Module Registers - Unified Channel specific registers, mIdx : emios module index 0 for 
...
/**@}*/
 /**@file    Reg_eSys_EMIOS.h
 @note  Violates MISRA 2004 Advisory Rule 19.7 VIOLATION: End of code block */
/*lint -restore */
