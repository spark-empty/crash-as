...
[!LOOP "McuModeSettingConf/*"!][!VAR "PCindex" = "@index"!][!//
...
STATIC CONST(Mcu_ClockConfigType, MCU_CONST) Mcu_ClockConfigPC_[!"num:i(@index+1)"!][[!"num:i(count(McuClockSettingConfig/McuClockReferencePoint/*))"!]] = {[!//
