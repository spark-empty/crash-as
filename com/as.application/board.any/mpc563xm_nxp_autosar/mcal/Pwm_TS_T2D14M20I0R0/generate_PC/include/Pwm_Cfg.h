...
@remarks Implements
*/
#define PWM_FEATURE_OPWMT    ([!"ecu:get('Pwm.EmiosOpwmtAvailable')"!])
...
/** @remarks Covers PWM076, PWM079 */
#define PWM_PRECOMPILE_SUPPORT
[!ENDIF!]
...
[!LOOP "PwmChannelConfigSet/*/PwmChannel/*"!]
    ...
    [!ENDLOOP!]
    [!IF "$Matchcounter = 1"!]
[!CODE!]#define [!"node:name(.)"!]         (Pwm_ChannelType)[!"PwmChannelId"!]
[!ENDCODE!]
[!ELSE!]
[!ERROR!]
...
#define PWM_INIT_CONFIG_PB_DEFINES \[!LOOP "PwmChannelConfigSet/*"!][!VAR "w"="$w + 1"!]
extern CONST(Pwm_ConfigType, PWM_CONST) [!"node:name(.)"!];[!IF "$w < $var_count1"!] \[!ENDIF!][!ENDLOOP!]


#endif /* PWM_PRECOMPILE_SUPPORT */
[!ELSE!]
#ifdef PWM_PRECOMPILE_SUPPORT
/* declaration of config set for PC configuration */
