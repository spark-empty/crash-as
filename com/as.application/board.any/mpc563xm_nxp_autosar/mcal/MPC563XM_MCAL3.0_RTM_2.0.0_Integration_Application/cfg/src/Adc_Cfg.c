...
{
  /* Hardware Unit 0  --  AN_17 */
  {
        (uint32)(ADC_CONV_COM_BN0  | ADC_CONV_COM_CAL  | ADC_128_CLOCK_CYCLES | ADC_CONV_COM_FMT_RJU | ((uint32)AN_17<<8)), /* Adc channel,s command */
