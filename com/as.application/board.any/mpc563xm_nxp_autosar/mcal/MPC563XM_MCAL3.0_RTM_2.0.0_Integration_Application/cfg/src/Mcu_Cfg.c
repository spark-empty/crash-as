...
#define MCU_AR_MAJOR_VERSION_PCCFG_C  3
#define MCU_AR_MINOR_VERSION_PCCFG_C  0
#define MCU_AR_PATCH_VERSION_PCCFG_C  0
#define MCU_SW_MAJOR_VERSION_PCCFG_C  2
#define MCU_SW_MINOR_VERSION_PCCFG_C  0
#define MCU_SW_PATCH_VERSION_PCCFG_C  0
...
/* Check if source file and MCU lld header file are of the same vendor */
    ...
    #if ((MCU_AR_MAJOR_VERSION_PCCFG_C != MCU_LLD_AR_MAJOR_VERSION) || \
         (MCU_AR_MINOR_VERSION_PCCFG_C != MCU_LLD_AR_MINOR_VERSION) || \
         (MCU_AR_PATCH_VERSION_PCCFG_C != MCU_LLD_AR_PATCH_VERSION))
...
/** @note  Violates MISRA 2004 Advisory Rule 19.15, Repeated include file, See @ref Mcu_Cfg_c_REF_1*/
#include "MemMap.h"
...
STATIC CONST(Mcu_ModeConfigType, MCU_CONST) Mcu_ModeConfigPC_1[1] ={
...
STATIC CONST(Mcu_ClockConfigType, MCU_CONST) Mcu_ClockConfigPC_1[1] = {/* start of Mcu_ClockConfig[0] */
    {
...
/*Enhanced*/
  ...
  (MCU_EXT_BUS_TAP_NOT_SELECTED|
   ...
   MCU_PLL_FEEDBACK_DIVIDE_RATIO(60)),  (MCU_PLL_LOSS_OF_CLOCK_DISABLE|   MCU_PLL_LOSS_OF_LOCK_RESET_DISABLE|   MCU_PLL_LOSS_OF_CLOCK_RESET_DISABLE|   MCU_PLL_LOSS_OF_LOCK_INTR_DISABLE|
   MCU_PLL_LOSS_OF_CLOCK_INTR_DISABLE|
   MCU_PLL_OUTPUT_DIVIDE_RATIO(2)),
...
/* put MCU_INIT_CONFIG_PC structure into specified section */
#endif /* MCU_PRECOMPILE_SUPPORT */
#define MCU_STOP_SEC_CONST_UNSPECIFIED
/*@note  Violates MISRA 2004 Advisory Rule 19.15, Repeated include file, See @ref Mcu_PBcfg_c_1*/
#include "MemMap.h"
/*==================================================================================================
