...
#endif
#define OSSTKSIZE 6240                     /* Common stack size */
...
#define OSNTSKS 4                          /* equal to  number of TASK objects  */
#define OSNXTSKS 3                         /* equal to  number of extended TASK objects */
#define OSNMAXREADYTSKS 4                  /*  */
...
#define OSNUSERISR 0                       /*  */
#define OSNISR 10                          /* equal to summ of number ISR, system timers and TPTimer */
