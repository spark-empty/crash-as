...
/*==================================================================================================
                                        LOCAL MACROS
==================================================================================================*/
#define SCHM_PWM_VENDOR_ID_C         43
#define SCHM_PWM_AR_MAJOR_VERSION_C  3
#define SCHM_PWM_AR_MINOR_VERSION_C  0
#define SCHM_PWM_AR_PATCH_VERSION_C  0
...
/* Check if SchM_Pwm source file and Std_Types header file are of the same ASR version */
#if ((SCHM_PWM_AR_MAJOR_VERSION_C != STD_TYPES_AR_MAJOR_VERSION) || \
     (SCHM_PWM_AR_MINOR_VERSION_C != STD_TYPES_AR_MINOR_VERSION))
#error "AutoSar Version Numbers of SchM_Pwm.c and Std_Types.h are different"
#endif

/* No ASR version exported by Mcal.h header file - skip check*/

/* Check if SchM_Pwm source file and SchM_Pwm header file are of the same version */
#if ((SCHM_PWM_AR_MAJOR_VERSION_C != SCHM_PWM_AR_MAJOR_VERSION) || \
     (SCHM_PWM_AR_MINOR_VERSION_C != SCHM_PWM_AR_MINOR_VERSION) || \
     (SCHM_PWM_AR_PATCH_VERSION_C != SCHM_PWM_AR_PATCH_VERSION))
#error "AutoSar Version Numbers of SchM_Pwm.c and SchM_Pwm.h are different"
#endif
#endif /*CHECK_AUTOSAR_VERSION*/

#if ((SCHM_PWM_SW_MAJOR_VERSION_C != SCHM_PWM_SW_MAJOR_VERSION) || \
     (SCHM_PWM_SW_MINOR_VERSION_C != SCHM_PWM_SW_MINOR_VERSION) || \
     (SCHM_PWM_SW_PATCH_VERSION_C != SCHM_PWM_SW_PATCH_VERSION))
#error "Software Version Numbers of SchM_Pwm.c and SchM_Pwm.h are different"
#endif

#if (SCHM_PWM_VENDOR_ID_C != SCHM_PWM_VENDOR_ID)
...
@remarks Implements 
*/
FUNC(uint32, SCHM_CODE) Pwm_schm_read_msr(void); 
#endif /*ifndef _COSMIC_C_MPC563XM_*/

FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_00(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_01(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_02(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_03(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_04(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_05(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_06(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_07(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_08(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_09(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_10(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_11(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_12(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_13(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_14(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_15(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_16(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_17(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_18(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_19(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_20(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_21(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_22(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_23(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_24(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_25(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_26(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_27(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_28(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_29(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_30(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_31(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_32(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_33(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_34(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_35(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_36(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_37(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_38(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_39(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_40(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_41(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_42(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_43(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_44(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_45(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_46(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_47(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_48(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_49(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_50(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_51(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_52(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_53(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_54(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_55(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_56(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_57(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_58(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_59(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_60(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_61(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_62(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_63(void);
FUNC(void, SCHM_CODE) SchM_Enter_PWM_EXCLUSIVE_AREA_64(void);

FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_00(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_01(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_02(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_03(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_04(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_05(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_06(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_07(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_08(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_09(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_10(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_11(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_12(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_13(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_14(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_15(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_16(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_17(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_18(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_19(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_20(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_21(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_22(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_23(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_24(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_25(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_26(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_27(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_28(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_29(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_30(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_31(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_32(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_33(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_34(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_35(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_36(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_37(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_38(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_39(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_40(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_41(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_42(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_43(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_44(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_45(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_46(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_47(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_48(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_49(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_50(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_51(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_52(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_53(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_54(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_55(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_56(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_57(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_58(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_59(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_60(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_61(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_62(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_63(void);
FUNC(void, SCHM_CODE) SchM_Exit_PWM_EXCLUSIVE_AREA_64(void);
...
@remarks Implements 
*/
ASM_KEYWORD FUNC(uint32, SCHM_CODE) Pwm_schm_read_msr(void)
{
    mfmsr r3
}
...
FUNC (void, SCHM_CODE) SchM_Enter_Pwm(VAR(uint8, AUTOMATIC) Pwm_InstanceId, VAR(uint8, AUTOMATIC) Pwm_ExclusiveArea)
{

    if (Pwm_InstanceId == SCHM_PWM_INSTANCE_0)
    {
     
     switch (Pwm_ExclusiveArea) {
 
            case PWM_EXCLUSIVE_AREA_00: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_00(); 
                break;         
            case PWM_EXCLUSIVE_AREA_01: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_01(); 
                break;         
            case PWM_EXCLUSIVE_AREA_02: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_02(); 
                break;         
            case PWM_EXCLUSIVE_AREA_03: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_03(); 
                break;         
            case PWM_EXCLUSIVE_AREA_04: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_04(); 
                break;         
            case PWM_EXCLUSIVE_AREA_05: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_05(); 
                break;         
            case PWM_EXCLUSIVE_AREA_06: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_06(); 
                break;         
            case PWM_EXCLUSIVE_AREA_07: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_07(); 
                break;         
            case PWM_EXCLUSIVE_AREA_08: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_08(); 
                break;         
            case PWM_EXCLUSIVE_AREA_09: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_09(); 
                break;         
            case PWM_EXCLUSIVE_AREA_10: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_10(); 
                break;         
            case PWM_EXCLUSIVE_AREA_11: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_11(); 
                break;         
            case PWM_EXCLUSIVE_AREA_12: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_12(); 
                break;         
            case PWM_EXCLUSIVE_AREA_13: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_13(); 
                break;         
            case PWM_EXCLUSIVE_AREA_14: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_14(); 
                break;         
            case PWM_EXCLUSIVE_AREA_15: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_15(); 
                break;         
            case PWM_EXCLUSIVE_AREA_16: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_16(); 
                break;         
            case PWM_EXCLUSIVE_AREA_17: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_17(); 
                break;         
            case PWM_EXCLUSIVE_AREA_18: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_18(); 
                break;         
            case PWM_EXCLUSIVE_AREA_19: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_19(); 
                break;         
            case PWM_EXCLUSIVE_AREA_20: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_20(); 
                break;         
            case PWM_EXCLUSIVE_AREA_21: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_21(); 
                break;         
            case PWM_EXCLUSIVE_AREA_22: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_22(); 
                break;         
            case PWM_EXCLUSIVE_AREA_23: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_23(); 
                break;         
            case PWM_EXCLUSIVE_AREA_24: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_24(); 
                break;         
            case PWM_EXCLUSIVE_AREA_25: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_25(); 
                break;         
            case PWM_EXCLUSIVE_AREA_26: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_26(); 
                break;         
            case PWM_EXCLUSIVE_AREA_27: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_27(); 
                break;         
            case PWM_EXCLUSIVE_AREA_28: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_28(); 
                break;         
            case PWM_EXCLUSIVE_AREA_29: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_29(); 
                break;         
            case PWM_EXCLUSIVE_AREA_30: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_30(); 
                break;         
            case PWM_EXCLUSIVE_AREA_31: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_31(); 
                break;         
            case PWM_EXCLUSIVE_AREA_32: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_32(); 
                break;         
            case PWM_EXCLUSIVE_AREA_33: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_33(); 
                break;         
            case PWM_EXCLUSIVE_AREA_34: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_34(); 
                break;         
            case PWM_EXCLUSIVE_AREA_35: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_35(); 
                break;         
            case PWM_EXCLUSIVE_AREA_36: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_36(); 
                break;         
            case PWM_EXCLUSIVE_AREA_37: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_37(); 
                break;         
            case PWM_EXCLUSIVE_AREA_38: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_38(); 
                break;         
            case PWM_EXCLUSIVE_AREA_39: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_39(); 
                break;         
            case PWM_EXCLUSIVE_AREA_40: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_40(); 
                break;         
            case PWM_EXCLUSIVE_AREA_41: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_41(); 
                break;         
            case PWM_EXCLUSIVE_AREA_42: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_42(); 
                break;         
            case PWM_EXCLUSIVE_AREA_43: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_43(); 
                break;         
            case PWM_EXCLUSIVE_AREA_44: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_44(); 
                break;         
            case PWM_EXCLUSIVE_AREA_45: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_45(); 
                break;         
            case PWM_EXCLUSIVE_AREA_46: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_46(); 
                break;         
            case PWM_EXCLUSIVE_AREA_47: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_47(); 
                break;         
            case PWM_EXCLUSIVE_AREA_48: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_48(); 
                break;         
            case PWM_EXCLUSIVE_AREA_49: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_49(); 
                break;         
            case PWM_EXCLUSIVE_AREA_50: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_50(); 
                break;         
            case PWM_EXCLUSIVE_AREA_51: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_51(); 
                break;         
            case PWM_EXCLUSIVE_AREA_52: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_52(); 
                break;         
            case PWM_EXCLUSIVE_AREA_53: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_53(); 
                break;         
            case PWM_EXCLUSIVE_AREA_54: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_54(); 
                break;         
            case PWM_EXCLUSIVE_AREA_55: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_55(); 
                break;         
            case PWM_EXCLUSIVE_AREA_56: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_56(); 
                break;         
            case PWM_EXCLUSIVE_AREA_57: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_57(); 
                break;         
            case PWM_EXCLUSIVE_AREA_58: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_58(); 
                break;         
            case PWM_EXCLUSIVE_AREA_59: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_59(); 
                break;         
            case PWM_EXCLUSIVE_AREA_60: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_60(); 
                break;         
            case PWM_EXCLUSIVE_AREA_61: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_61(); 
                break;         
            case PWM_EXCLUSIVE_AREA_62: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_62(); 
                break;         
            case PWM_EXCLUSIVE_AREA_63: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_63(); 
                break;         
            case PWM_EXCLUSIVE_AREA_64: 
                SchM_Enter_PWM_EXCLUSIVE_AREA_64(); 
                break;         
 
            default:
                 /**
                 @brief the code reached this point because
                        SchM_Enter_Pwm was called with an invalid Pwm_ExclusiveArea
                 */
...
FUNC (void, SCHM_CODE) SchM_Exit_Pwm(VAR(uint8, AUTOMATIC) Pwm_InstanceId, VAR(uint8, AUTOMATIC) Pwm_ExclusiveArea)
{
    ...
    if (Pwm_InstanceId == SCHM_PWM_INSTANCE_0)
    {
     ...
     switch (Pwm_ExclusiveArea) {
            ...
            case PWM_EXCLUSIVE_AREA_07: 
                ...
                break;  
            case PWM_EXCLUSIVE_AREA_08: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_08(); 
                break;  
            case PWM_EXCLUSIVE_AREA_09: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_09(); 
                break;  
            case PWM_EXCLUSIVE_AREA_10: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_10(); 
                break;  
            case PWM_EXCLUSIVE_AREA_11: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_11(); 
                break;  
            case PWM_EXCLUSIVE_AREA_12: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_12(); 
                break;  
            case PWM_EXCLUSIVE_AREA_13: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_13(); 
                break;  
            case PWM_EXCLUSIVE_AREA_14: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_14(); 
                break;  
            case PWM_EXCLUSIVE_AREA_15: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_15(); 
                break;  
            case PWM_EXCLUSIVE_AREA_16: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_16(); 
                break;  
            case PWM_EXCLUSIVE_AREA_17: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_17(); 
                break;  
            case PWM_EXCLUSIVE_AREA_18: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_18(); 
                break;  
            case PWM_EXCLUSIVE_AREA_19: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_19(); 
                break;  
            case PWM_EXCLUSIVE_AREA_20: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_20(); 
                break;  
            case PWM_EXCLUSIVE_AREA_21: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_21(); 
                break;  
            case PWM_EXCLUSIVE_AREA_22: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_22(); 
                break;  
            case PWM_EXCLUSIVE_AREA_23: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_23(); 
                break;  
            case PWM_EXCLUSIVE_AREA_24: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_24(); 
                break;  
            case PWM_EXCLUSIVE_AREA_25: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_25(); 
                break;  
            case PWM_EXCLUSIVE_AREA_26: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_26(); 
                break;  
            case PWM_EXCLUSIVE_AREA_27: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_27(); 
                break;  
            case PWM_EXCLUSIVE_AREA_28: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_28(); 
                break;  
            case PWM_EXCLUSIVE_AREA_29: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_29(); 
                break;  
            case PWM_EXCLUSIVE_AREA_30: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_30(); 
                break;  
            case PWM_EXCLUSIVE_AREA_31: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_31(); 
                break;  
            case PWM_EXCLUSIVE_AREA_32: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_32(); 
                break;  
            case PWM_EXCLUSIVE_AREA_33: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_33(); 
                break;  
            case PWM_EXCLUSIVE_AREA_34: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_34(); 
                break;  
            case PWM_EXCLUSIVE_AREA_35: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_35(); 
                break;  
            case PWM_EXCLUSIVE_AREA_36: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_36(); 
                break;  
            case PWM_EXCLUSIVE_AREA_37: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_37(); 
                break;  
            case PWM_EXCLUSIVE_AREA_38: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_38(); 
                break;  
            case PWM_EXCLUSIVE_AREA_39: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_39(); 
                break;  
            case PWM_EXCLUSIVE_AREA_40: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_40(); 
                break;  
            case PWM_EXCLUSIVE_AREA_41: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_41(); 
                break;  
            case PWM_EXCLUSIVE_AREA_42: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_42(); 
                break;  
            case PWM_EXCLUSIVE_AREA_43: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_43(); 
                break;  
            case PWM_EXCLUSIVE_AREA_44: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_44(); 
                break;  
            case PWM_EXCLUSIVE_AREA_45: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_45(); 
                break;  
            case PWM_EXCLUSIVE_AREA_46: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_46(); 
                break;  
            case PWM_EXCLUSIVE_AREA_47: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_47(); 
                break;  
            case PWM_EXCLUSIVE_AREA_48: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_48(); 
                break;  
            case PWM_EXCLUSIVE_AREA_49: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_49(); 
                break;  
            case PWM_EXCLUSIVE_AREA_50: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_50(); 
                break;  
            case PWM_EXCLUSIVE_AREA_51: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_51(); 
                break;  
            case PWM_EXCLUSIVE_AREA_52: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_52(); 
                break;  
            case PWM_EXCLUSIVE_AREA_53: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_53(); 
                break;  
            case PWM_EXCLUSIVE_AREA_54: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_54(); 
                break;  
            case PWM_EXCLUSIVE_AREA_55: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_55(); 
                break;  
            case PWM_EXCLUSIVE_AREA_56: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_56(); 
                break;  
            case PWM_EXCLUSIVE_AREA_57: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_57(); 
                break;  
            case PWM_EXCLUSIVE_AREA_58: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_58(); 
                break;  
            case PWM_EXCLUSIVE_AREA_59: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_59(); 
                break;  
            case PWM_EXCLUSIVE_AREA_60: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_60(); 
                break;  
            case PWM_EXCLUSIVE_AREA_61: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_61(); 
                break;  
            case PWM_EXCLUSIVE_AREA_62: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_62(); 
                break;  
            case PWM_EXCLUSIVE_AREA_63: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_63(); 
                break;  
            case PWM_EXCLUSIVE_AREA_64: 
                SchM_Exit_PWM_EXCLUSIVE_AREA_64(); 
                break;  

            default:
                 /**
                 @brief the code reached this point because
                        SchM_Exit_Pwm was called with an invalid Pwm_ExclusiveArea
                 */
                while(1) {}; /*wait here for user debug intervention*/
                /*break; */
...
@remarks Implements 
*/
FUNC(void, SCHM_CODE) SchM_Check_pwm(void)
{
