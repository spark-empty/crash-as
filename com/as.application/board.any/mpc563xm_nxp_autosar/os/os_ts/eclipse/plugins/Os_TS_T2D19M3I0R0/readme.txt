...
This directory contains Os_TS_T2D19M3I0R0 configuration plugin for XPC567XF.

The  Os_TS_T2D19M3I0R0 directory contains the following subdirectories:

Os_TS_T2D19M3I0R0\autosar\               ; OS configuration directory
Os_TS_T2D19M3I0R0\autosar\Os.epd         ; OS configuration file

Os_TS_T2D19M3I0R0\config                 ; TresosECU OS plugin configuration directory
Os_TS_T2D19M3I0R0\config\Os.xdm          ; TresosECU OS plugin configuration file

Os_TS_T2D19M3I0R0\make
Os_TS_T2D19M3I0R0\make\os_defs.mak       ; AUTOSAR OS defines makefile
Os_TS_T2D19M3I0R0\make\os_rules.mak      ; AUTOSAR OS rules makefile

Os_TS_T2D19M3I0R0\META-INF               ; TresosECU OS plugin manifest directory
Os_TS_T2D19M3I0R0\META-INF\MANIFEST.MF   ; TresosECU OS plugin manifest file
Os_TS_T2D19M3I0R0\META-INF\cryptomanifest.mf     ; TresosECU OS plugin cryptomanifest
Os_TS_T2D19M3I0R0\META-INFf\cryptomanifestsig.mf ; TresosECU OS plugin cryptosignature

Os_TS_T2D19M3I0R0\anchors.xml             ; TresosECU OS plugin help definition file
Os_TS_T2D19M3I0R0\plugin.xml             ; TresosECU OS plugin declaration file
Os_TS_T2D19M3I0R0\readme.txt             ; this file
...
described with forward slashes.
 ...
 should be  
 "<NewDirectoryPath>/<NewDirectoryName>/eclipse/plugins/Os_TS_T2D19M3I0R0"
...
Os_TS_T2D19M3I0R0\plugin.xml is prepared in such a way,
that Tresos 2009.a can run SysGen (Tresos External Generator applicable to Os) for created EPC-file.
The command line in Os_TS_T2D19M3I0R0\plugin.xml contains SysGen call applicable
for SC1 and SC2.
To apply SysGen for SC3 and SC4, the user has to modify in Os_TS_T2D19M3I0R0\plugin.xml line:
